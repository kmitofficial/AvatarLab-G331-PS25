...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col font-sans">
      <Navbar />
      ...
      >
        <section
          ref={parentRef}
          className="relative flex h-[50rem] w-full bg-white dark:bg-black"
        >
          {/* Left side content */}
          ...
          <div className="flex flex-1 items-center justify-end">
            <video
              className="w-2/3 h-auto object-cover mr-8 mt-40 relative z-10"
              autoPlay
              loop
              muted
              playsInline
