...
export default function SignIn() {
    ...
    const handleSignUp = async (e: React.FormEvent) =>{
        ...
        try {
            ...
            if(response.ok){
                router.push('/Login');
                toast.success(message,{transition:Slide,autoClose:3000,position:'top-center',theme:'light'});
            }     
            else toast.error(message,{transition:Slide,autoClose:3000,position:'top-center',theme:'light'});
        } catch (error) {
