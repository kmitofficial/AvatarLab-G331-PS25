...
export default function VideoEditorPage() {
  ...
  const handleApplyBackground = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/user/video-background", {
        method: "POST",
        body: formData,
      })
  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit">
      ...
      <div className="container mx-auto p-2">
        <div className="p-2">
          <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 mb-6">
